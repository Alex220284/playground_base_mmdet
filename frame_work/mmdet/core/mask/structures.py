...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from frame_work.mmdet.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from frame_work.mmdet.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from frame_work.mmdet.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from frame_work.mmdet.core.mask.structures import PolygonMasks
